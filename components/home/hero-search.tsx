  ...
  return (
    <Card className="shadow-lg">
      <CardContent className="p-0">
        <Tabs defaultValue="mua" className="w-full" onValueChange={setSearchType}>
          <TabsList className="w-full rounded-t-lg grid grid-cols-3 h-14">
            <TabsTrigger value="mua" className="text-base">Mua</TabsTrigger>
            <TabsTrigger value="thue" className="text-base">Thuê</TabsTrigger>
            <TabsTrigger value="duAn" className="text-base">Dự án</TabsTrigger>
          </TabsList>
