...
export const priceRangesSets = {
  ...
  renting: [
    { value: "tat-ca", label: "tất cả mức giá" },
    { value: "duoi-1-trieu", label: "dưới 1 triệu/tháng" },
    { value: "1-3-trieu", label: "1 - 3 triệu/tháng" },
    { value: "3-5-trieu", label: "3 - 5 triệu/tháng" },
    { value: "5-10-trieu", label: "5 - 10 triệu/tháng" },
    { value: "10-40-trieu", label: "10 - 40 triệu/tháng" },
    { value: "40-70-trieu", label: "40 - 70 triệu/tháng" },
    { value: "70-100-trieu", label: "70 - 100 triệu/tháng" },
    { value: "tren-100-trieu", label: "trên 100 triệu/tháng" },
  ],
  project: [
    { value: "tat-ca", label: "tất cả mức giá" },
...
export const postTypes = [
  ...
  },
  {
    ...
    filters: [
      ...
      { value: "dienTich", label: "Diện tích", items: areaRanges.project },
    ],
  },
];
